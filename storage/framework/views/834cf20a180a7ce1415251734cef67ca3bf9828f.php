...
<body>
  <div class="header head-top " id="home">
     ...
     <ul>
            <li><a href="/nandur/public/">Beranda</a></li><label>/</label>
            <li><a href="/nandur/public/login">Login</a></li><label>/</label>
            <li><a href="/nandur/public/data" class="active">Data</a></li><label>/</label>
    </ul>
     <!-- script for menu -->
		 ...
		 <div class="content">
		   ...
		   <div class="service-section1">
				<div class="container">
					...
					<h4>Registrasi</h4>
					<p>Untuk pendafataran akun petani baru, diharapkan bagi yang sudah terdaftar untuk melakukan registrasi terhadap petani baru pada menu Daftar</p>
					</div>
					<div class="col-md-4 service-grid wow fadeInDown Big animated animated" data-wow-delay="0.4s">
					<img src="images/icon2.png" class="img-responsive" alt="/">
						<h4>Transparan</h4>
						<p>Web ini digunakan agar hasil dari panen dapat diketahui para petani sebagai acuan</p>
						</div>
					...
					<img src="images/icon3.png" class="img-responsive" alt="/">
						<h4>Peningkatan</h4>
						<p>Diharapkan web ini dapat berperan dalam peningkatan hasil panen para petani pada daerah Sukun, Pandanwangi, SukoHarjo, dan Batu</p>
	`					</div>
					<div class="clearfix"></div>
					</div>
		   </div>
	...
	<li>lorem,Cras consequat iaculis id vehicula</li>
	   ...
	   <li><i class="smartphone"></i></li>
		...
		<li><a href="mailto:sans482123@gmail.com">bcdefg@hijs.dfh</a>
...
<?php /**PATH E:\xampp\htdocs\nandur\resources\views/layout/user.blade.php ENDPATH**/ ?>